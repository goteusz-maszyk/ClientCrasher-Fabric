...
public class AlwaysCrashCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        List<String> alwaysCrash = ClientCrasherPaper.getInstance().getConfig().getStringList("always-crash");
        ...
        ClientCrasherPaper.getInstance().getConfig().set("always-crash", alwaysCrash);
        return true;
    }
}
